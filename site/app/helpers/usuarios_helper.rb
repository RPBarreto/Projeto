module UsuariosHelper
  ...
  # $no_debug = 1 #20/10/2014, ainda não sei o que isso faz
  ...
  #     k=0
  #     while k<$total_wheels-1 do #2/11 funciona, como eu não tenho a minima ideia, foi isso que saiu do pentagrama
  #       k+=1
